...
/**
 * In case of sampling event occurrence records stored in extensions, this converter extracts occurrence records {@link
 * DwcTerm#Occurrence} from extension and returns them as list of {@link ExtendedRecord}
 *
