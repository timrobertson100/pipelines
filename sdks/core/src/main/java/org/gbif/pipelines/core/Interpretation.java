...
public class Interpretation<S> {
  ...
  public class Handler<T> {
    ...
    /**
     * @param func BiConsumer for applying an interpretation function, where S as a source data object and T as a target
     *     data object
     */
    public Handler<T> via(BiConsumer<S, T> func) {
    ...
    /**
     * @param func Consumer for applying an interpretation function, where T as a source data object and as a target
     *     data object
     */
    public Handler<T> via(Consumer<T> func) {
