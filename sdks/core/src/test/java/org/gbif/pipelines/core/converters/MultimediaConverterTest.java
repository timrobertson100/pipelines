        ...
        MultimediaRecord.newBuilder()
            ...
            .setMultimediaItems(
                Collections.singletonList(
                    Multimedia.newBuilder().setIdentifier("http://url-i1").setReferences("http://url-r1").build()))
            .build();
  ...
  public void duplicateTest() {
    ...
    ImageRecord ir =
        ImageRecord.newBuilder()
            ...
            .setImageItems(
                Collections.singletonList(
                    Image.newBuilder().setIdentifier("http://url-i1").setReferences("http://url-r1").build()))
            .build();
