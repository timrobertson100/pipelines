...
public class AudubonInterpreterTest {
  ...
  public void audubonTest() {
    ...
    audubon.put(
        "http://rs.tdwg.org/ac/terms/accessURI", "https://api.idigbio.org/v2/media/414560e3c8514266b6d9e1888a792564");
    audubon.put(
        "http://ns.adobe.com/xap/1.0/rights/Owner", "Carnegie Museum of Natural History Herps Collection (CM:Herps)");
  ...
  public void wrongFormatTest() {
    ...
    audubon1.put(
        "http://purl.org/dc/terms/identifier", "http://medialib.naturalis.nl/file/id/ZMA.AVES.11080/format/large");
    ...
    audubon1.put(
        "http://rs.tdwg.org/ac/terms/accessURI", "http://medialib.naturalis.nl/file/id/ZMA.AVES.11080/format/large");
  ...
  public void swappedValuesTest() {
    ...
    audubon1.put(
        "http://purl.org/dc/terms/identifier", "https://data.biodiversitydata.nl/xeno-canto/observation/XC449504");
